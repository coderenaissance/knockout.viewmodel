...
ko.viewmodel = (function () {
    ...
    function GetPathSettings(settings:Object, context: IMappingContext) {
    ...
    function GetPathSettingsDictionary(options:IMappingOptions) {
    ...
    function isNullOrUndefined(obj:any) {//checks if obj is null or undefined
    ...
    function isPrimativeOrDate(obj:any) {
        return obj === null || obj === undefined || obj.constructor === String || obj.constructor === Number || obj.constructor === Boolean || obj instanceof Date;
    }

    function fnRecursiveFrom(modelObj:any, settings:Object, context:IMappingContext, pathSettings?: IMappingOptions) {
    ...
    function fnRecursiveTo(viewModelObj:any, context: IMappingContext) {
    ...
    function fnRecursiveUpdate(modelObj:any, viewModelObj:any, context:IMappingContext, parentObj?:any) {
    ...
    function initInternals(options, startMessage) {
        ...
        if (window.console && options.logging) {
            ...
            fnLog = function fnUpdateConsole(context, pathSettings: any, settings: IMappingOptions) {
                var msg;
    ...
    return {
        ...
        fromModel: function fnFromModel(model:any, options:IMappingOptions) {
        ...
        toModel: function fnToModel(viewmodel:any) {
            initInternals(this.options, "Mapping To Model");
            return fnRecursiveTo(viewmodel, rootContext);
        },
        updateFromModel: function fnUpdateFromModel(viewmodel:any, model:any) {
